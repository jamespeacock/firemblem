...
public enum CharacterType {
	MYR("Myrmidon"), LORD("Lord"), KNG("Knight"), FGT("Fighter"), ARCH("Archer"), MAGE("Mage"), 
	CLR("Cleric"), RCRT("Recruit"), CVLR("Cavalier"), BRSKR("Beserker"), PLDN("Paladin"), 
	GNRL("General"), MCNRY("Mercenary"), PKNG("Pegasus Knight"), JNYMN("Journeyman"),
	...
	private static String [] read(){
		if(!textFileRead){
			try{
				Scanner reader = new Scanner(new FileReader("src/data/usableweapons.txt"));
				for(int i = 0; i < 10; i++)
