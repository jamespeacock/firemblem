...
public class ParseMethods {
	...
	public static void initializeWeaponSearchMap(){
		String [] names = {"Sword", "Lance", "Axe", "Bow", "Anima", "Light", "Dark", "Monster", 
				"Staff"};
		WeaponType [] types = {WeaponType.SWORD, WeaponType.LANCE, WeaponType.AXE, WeaponType.BOW, 
				WeaponType.ANIMA, WeaponType.LIGHT, WeaponType.DARK, WeaponType.MONSTER, WeaponType.STAFF,};
